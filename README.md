...
Исходная аналитика проверена 61 тестом, аудитом формул и программной проверкой 38 карточек официального набора. После добавления backend **89 тестов прошли на Windows и в Docker Linux**, также выполнен сквозной HTTP-сценарий на официальных данных. Источники: [проверка backend](docs/backend-verification.md), [аудит аналитики](AUDIT_LANE_A.md), [семантический QA](docs/qa-real-data.md), [проверки исходного CLI/Docker](docs/audit-sha256-20260923.md). Эти проверки подтверждают согласованность реализации, но не точность обнаружения нарушений.
