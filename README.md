...
<p align="center">
  <a href="#установка-и-запуск"><strong>Запустить</strong></a> ·
...
Аудит текущей публикации: 2 248 evidence и 20 why, несовпадений фактов не найдено; длина 88–145 символов (лимит 200). Скрипт только читает файлы. Смысловые ограничения и предложения улучшения — в [отчёте](docs/evidence-audit.md).
