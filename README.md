...
Проверки охватывают аналитику, обновлённый UI и backend: шесть ролей и объяснения, ограничения для seed и depth=4, пороги и конкурирующие роли, изоляты, Top, кластеры, runtime <300 секунд, интерактивные графы, API, импорт, очередь и восстановление worker.
