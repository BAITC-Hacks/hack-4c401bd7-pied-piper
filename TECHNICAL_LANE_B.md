...
Проверено: 63 pytest/AppTest теста; Chromium на реальном Top-клиенте — перемещение узла и связанных стрелок, zoom, reset, оба режима, подписи/подсветка, обзор сообществ, отсутствие JS-ошибок и внешних HTTP-запросов. Docker-образ собран успешно. Проверка графа при установленном Playwright:
