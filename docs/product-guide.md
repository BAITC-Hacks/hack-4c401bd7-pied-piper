...
Аудит текущей публикации: 2 248 evidence и 20 why, несовпадений фактов не найдено; длина 64–110 символов. Скрипт только читает файлы. Смысловые ограничения и предложения улучшения — в [отчёте](evidence-audit.md).
